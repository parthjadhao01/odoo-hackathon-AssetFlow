...
-- CreateEnum
CREATE TYPE "AuditVerdict" AS ENUM ('PENDING', 'VERIFIED', 'MISSING', 'DAMAGED');
...
-- AddForeignKey
ALTER TABLE "Transfer" ADD CONSTRAINT "Transfer_fromEmployeeId_fkey" FOREIGN KEY ("fromEmployeeId") REFERENCES "Employee"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "Transfer" ADD CONSTRAINT "Transfer_toEmployeeId_fkey" FOREIGN KEY ("toEmployeeId") REFERENCES "Employee"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
